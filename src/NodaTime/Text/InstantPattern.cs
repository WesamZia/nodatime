...
namespace NodaTime.Text
{
    ...
    public sealed class InstantPattern : IPattern<Instant>
    {
        ...
        private static InstantPattern Create([NotNull] string patternText, [NotNull] NodaFormatInfo formatInfo, Instant templateValue)
        {
            Preconditions.CheckNotNull(patternText, nameof(patternText));
            Preconditions.CheckNotNull(formatInfo, nameof(formatInfo));
            var pattern = templateValue == DefaultTemplateValue
                ? formatInfo.InstantPatternParser.ParsePattern(patternText)
                : new InstantPatternParser(templateValue).ParsePattern(patternText, formatInfo);
        ...
        private InstantPattern WithFormatInfo([NotNull] NodaFormatInfo formatInfo) =>
            Create(PatternText, formatInfo, DefaultTemplateValue);
